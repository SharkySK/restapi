...
class Facility(models.Model):
    ...
    # Foreign Keys On delete set to null

    billing_Opt = models.ForeignKey(Billing_opt, on_delete=models.SET_NULL)
    opening_Hours = models.ForeignKey(Opening_hours, on_delete=models.SET_NULL)
    booking_Opt = models.ForeignKey(Booking_opt, on_delete=models.SET_NULL)
...
class User_account(models.Model):
    ...
    billing_Opt = models.ForeignKey(Billing_opt, on_delete=SET_NULL)
    training_Course = models.ForeignKey(Training_course, on_delete=SET_NULL)
    package_Opt = models.ForeignKey(Package_opt, on_delete=SET_NULL)
...
class Equipment(models.Model):
    ...
    equipment_Bridge = models.ForeignKey(Bridge, on_delete=SET_NULL)


class Activity_log(models.Model):
    log_Date = models.DateTimeField()
    log_Time = models.TimeField()
    log_Equipment = models.ForeinKey(Equipment, on_delete=DO_NOTHING)
    log_User = models.ForeignKey(User_account, on_delete=DO_NOTHING)


class Booking_schedule(models.Model):
    booking_Start = models.DateTimeField()
    booking_End = models.DateTimeField()
    booking_Equipment = models.ForeignKey(Equipment, on_delete=PROTECTED)
    booking_User = models.ForeignKey(User_account, on_delete=CASCADE)
